        ...
        <div className="footer-grid">
          ...
          <div className="contact-info">
            ...
            <ul>
              <li>
                ...
                <a href={'mailto:coolchess_online@mail.ru'}>
                  coolchess_online@mail.ru
                </a>
              </li>
              <li>
                <svg className="contact-icon" viewBox="0 0 24 24">
          ...
          <div className="social-links">
            ...
            <div className="social-icons">
              <a href={LINK_TELEGRAMM} aria-label="Telegram" target="_blank" rel="noopener noreferrer">
              ...
              <a href={LINK_WHATS_UP} aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
