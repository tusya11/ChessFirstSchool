...
export const teamData = [
  ...
  },
  {
    ...
    dignity: "Кандидат в мастера спорта",
    description:
      "Многократный призер и чемпионка Северо-Кавказского Федерального округа по классическим, быстрым шахматам и блицу.<br />Дважды участница Финала Высшей лиги России среди женщин. Серебряный призер Спартакиады в Белгороде, чемпионка и призер областных межвузовских соревнований ",
    image: image2,
  },
  {
    id: 3,
