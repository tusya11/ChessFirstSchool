    ...
    () => [
      {
        id: 2,
        title:
          "Как играть против выключенных фигур: мастер-класс Артура Габриеляна",
        content:
          "27 сентября в 11:00 (мск) пройдёт лекция о стратегии игры против выключенных и отдалённых фигур соперника. Разбор типичных планов, практические рекомендации и примеры из партий.",
        date: "16.09.26",
        period: "27.09.2026 - 27.09.2026",
        isUrgent: true,
