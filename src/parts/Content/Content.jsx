...
const NewPricePageLazy = React.lazy(() => import('../../pages/NewPricePage/NewPricePage'));

const NewTeamPageLazy = React.lazy(() => import('../../pages/NewTeamPage/NewTeamPage'));
...
const Content = () => {
  ...
  useEffect(() => {
    if (blockTitle && isDomLoaded) {
      ...
      const y = foundElement.getBoundingClientRect().top + currentScrollPos + yOffset;
  ...
  return (
    <div className="content__container">
      <Preview />
      <RecomendedItems items={recomendedItems} padding={isXS ? '30px 20px' : '40px 40px 60px'} />
      <AboutUsPage />
